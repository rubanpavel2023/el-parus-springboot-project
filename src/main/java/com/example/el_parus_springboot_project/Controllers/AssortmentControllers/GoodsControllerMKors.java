...
@Controller
public class GoodsControllerMKors {

    @Autowired
    private GoodsRepository goodsRepository;

    @GetMapping("/mens-shoes-mkors")
    public String showMensShoes(Model model) {
        List<Goods> goods = goodsRepository.findByCategory("M.KORS Men's Shoes");
        model.addAttribute("goods", goods);
        return "mkorsMensShoes";
    }

    @GetMapping("/womens-shoes-mkors")
    public String showWomensShoes(Model model) {
        List<Goods> goods = goodsRepository.findByCategory("M.KORS Women's Shoes");
        model.addAttribute("goods", goods);
        return "mkorsWomensShoes";
    }
}
